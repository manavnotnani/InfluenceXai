...
export function IntegratedLandingPage() {
  ...
  const testimonials = [
    { name: 'Sarah J.', role: 'Fashion Influencer', content: 'InfluenceX.ai has revolutionized how I collaborate with brands. It\'s so easy to use!' },
    { name: 'Tech Innovations Inc.', role: 'Tech Brand', content: 'We\'ve seen a 40% increase in ROI since using InfluenceX.ai for our influencer campaigns.' },
  ]
        ...
        return (
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-300 mb-4">
              Your {accountType} account has been created. Welcome to InfluenceX.ai!
            </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-gray-100">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <p className="text-xl mb-8 text-gray-300">Join InfluenceX.ai today and experience the power of AI-driven collaborations</p>
        <Dialog>
          <DialogTrigger asChild>
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h4 className="text-lg font-bold mb-4 text-white">InfluenceX.ai</h4>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm">
            © 2024 InfluenceX.ai All rights reserved.
          </div>
        </div>
      </footer>
    </div>
